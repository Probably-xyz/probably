...
export const FounderCard = () => {
  return (  
    <div className="relative max-w-xl">
      ...
      <div className='flex flex-col h-full px-5 py-6 rounded-md border border-slate-300 bg-slate-50'>
...
export const InvestorCard = () => {
  ...
  return(
    <div className="relative max-w-xl">
      ...
      <div className='flex flex-col px-5 py-6 rounded-md border border-slate-300 bg-slate-50'>
        <h1 className="text-3xl mb-2 font-medium text-left leading-tight text-slate-800" style={ubuntu.style}> 
           The Investor's Club
        </h1>
        <p className="text-sm text-slate-700">
